...
# ════════════════════════════════════════════════════════════════
    ...
    if d:
        ...
        if selected_stock != '(선택하세요)':
            ...
            if stock:
                # 세부 데이터 글자 크기 축소 (이 상세 뷰에만 스코프)
                st.markdown('<style>\n.st-key-stk_detail [data-testid="stMetricValue"]{font-size:1.05rem !important;}\n.st-key-stk_detail [data-testid="stMetricLabel"],\n.st-key-stk_detail [data-testid="stMetricLabel"] p{font-size:.72rem !important;}\n.st-key-stk_detail [data-testid="stMetricDelta"]{font-size:.8rem !important;}\n.st-key-stk_detail h2{font-size:1.25rem !important;}\n.st-key-stk_detail h4{font-size:.92rem !important;}\n.st-key-stk_detail h5{font-size:.85rem !important;}\n.st-key-stk_detail [data-testid="stDataFrame"]{font-size:.8rem !important;}\n</style>', unsafe_allow_html=True)
                with st.container(key='stk_detail'):
